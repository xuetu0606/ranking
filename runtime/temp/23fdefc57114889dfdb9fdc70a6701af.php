<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\workingspace\ranking\public/../application/index\view\index\forget.html";i:1517327034;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>忘记密码-「2018考研初试成绩排名系统」</title>
    ...
    <script src="/static/js/index/forget-data.js"></script>
</head>

<body ng-controller="ranking_index_forget_controller">
    <div class="center">
        <div>
            2018年考研初试成绩查询排名
        </div>
        ...
        <div>
            <input type="button" value="修改密码" ng-click="forget();">
        </div>
        <div>
